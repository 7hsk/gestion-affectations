                            ...
                            <div class="form-group" id="filiere-selection" style="display: none;">
                                ...
                                <div class="card">
                                    <div class="card-body p-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="filiere_base[]" id="filiere_gi" value="GI">
                                            <label class="form-check-label" for="filiere_gi">
                                                <strong>GI - Génie Informatique</strong>
                                                <small class="text-muted d-block">Inclut: GI1, GI2, GI3</small>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="filiere_base[]" id="filiere_id" value="ID">
                                            <label class="form-check-label" for="filiere_id">
                                                <strong>ID - Ingénierie des Données</strong>
                                                <small class="text-muted d-block">Inclut: ID1, ID2, ID3</small>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="filiere_base[]" id="filiere_gc" value="GC">
                                            <label class="form-check-label" for="filiere_gc">
                                                <strong>GC - Génie Civil</strong>
                                                <small class="text-muted d-block">Inclut: GC1, GC2, GC3</small>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="filiere_base[]" id="filiere_gm" value="GM">
                                            <label class="form-check-label" for="filiere_gm">
