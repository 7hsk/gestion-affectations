        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Ajoutez une nouvelle unité d'enseignement au système</p>
                </div>
                <div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('responsable_id') is-invalid @enderror"
                                        ...
                                        @foreach($teachers as $teacher)
                                            <option value="{{ $teacher->id }}" {{ old('responsable_id') == $teacher->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <span id="total-hours">0</span> heures
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-1"></i>Créer l'UE
                                    </button>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Note: Département and Filière are independent - no filtering needed
    // This allows cross-departmental UE assignments
